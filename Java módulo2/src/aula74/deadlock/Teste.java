...
public class Teste {
	...
	public static void main(String[] args) {
		...
		Thread t1= new Thread() {
			public void run() {
				synchronized(RECURSO1) {
					...
					System.out.println("Thread #1: bloqueou o objeto 1");
		...
		Thread t2= new Thread() {
			public void run() {
				synchronized(RECURSO2) {
					...
					System.out.println("Thread #2: bloqueou o objeto 2");
		...
		t1.start();
		t2.start();
	}// para evitar deadlocks usa- se sinchronized, wait e notify
